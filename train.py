...
from qr_forcaster.Metrits.Losses import DummyLoss
...
if __name__ == '__main__':
    train_el_dataloader, val_el_dataloader = DatasetHandler(data_path, num_samples=100, hist_hours=168, pred_horizon=24, batch_size=32).load_dataset()
