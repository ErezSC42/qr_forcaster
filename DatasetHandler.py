...
class DatasetHandler:
    ...
    def load_dataset(self, df: pd.DataFrame = None, dict_df_features:pd.DataFrame=None,split: bool = True, num_workers=0):
        ...
        if split:
            (df_target_train, dict_df_feature_train), (df_target_val, dict_df_feature_val) = self.split_df(df, dict_df_features, True)
    ...
    def split_df(self, df:pd.DataFrame, dict_df_features:dict,split_assets: bool=True):
        ...
        if split_assets:
            ...
            dict_features_test = {name_asset: dict_df_features[name_asset] for name_asset in test_assets}
        ...
        return (df_target_train,dict_features_train), (df_target_val,dict_features_test) # (df_train, df_feature_train) , ()
